<%@ Page Language="C#" AutoEventWireup="true" Title="СДН :: Адміністрування :: Користувачі"
    MasterPageFile="~/MasterPage.Master" CodeBehind="UserManager.aspx.cs" Inherits="ELMS13.AdminHome.UserManager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="Server">
    ...
    <p>
        <asp:Button runat="server" ID="btn_add_user" Text="Додати користувача" OnClick="btn_add_user_Click"/>
    </p>
