<%@ Page Language="C#" Title="СДН :: Звіти" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ELMS13.Reports.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="Server">
    ...
    <ul class="link-list-vertical">
        ...
        <li><a href="ReportFloatMatrixProgressOnCourse.aspx" title="Розширена шахматка виконання контрольних завдань">Розширена шахматка виконання контрольних завдань</a></li>
