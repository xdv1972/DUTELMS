<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="UserEnrollmentManager.aspx.cs" Inherits="ELMS13.MethodistHome.UserEnrollmentManager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <uc1:EUserEnrollmentManager ID="uc_enroll" runat="server"  VisibleAccess="Methodist"/>
</asp:Content>
