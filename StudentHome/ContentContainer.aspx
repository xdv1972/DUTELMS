<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContentContainer.aspx.cs"
    Inherits="ELMS13.StudentHome.ContentContainer" %>
...
<body class="cdtotal">
    <form id="form1" runat="server">
        <uc1:EContentContainer runat="server" ID="EContentContainer" ViewAccess ="Student" />
